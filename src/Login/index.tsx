...
import { loginAction } from '../common/actions';
import { ParamsLogin, User } from '../common/apis';
...
export default function LoginPage({ history }: { history: any }) {
  ...
  const { register, handleSubmit, formState: { errors }, setValue } = useForm<ParamsLogin>();
