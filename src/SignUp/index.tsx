...
import { signUpAction } from '../common/actions';
import { ParamsSignUp, User } from '../common/apis';
...
export default function SignUpPage({ history }: { history: any }) {
  ...
  const { username } = useSelector<AppState, User>(state => state.userReducer);
  const { register, handleSubmit, watch, formState: { errors }, setValue } = useForm<ParamsSignUp>();
      ...
      <div className={styles.container}>
        ...
        <form onSubmit={handleSubmit(data => handleSignUp(data))}>
          ...
          <TextField
            ...
            name="username"
            inputRef={
              (register('username', { required: true, minLength: 6, maxLength: 32 }) as any)
            }
          ...
          <TextField
            ...
            name="password"
            inputRef={
              (register('password', { required: true, minLength: 6, maxLength: 32 }) as any)
            }
